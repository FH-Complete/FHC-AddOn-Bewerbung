...
$this->phrasen['bewerbung/welcome']='Welcome to the Online Application of the '.CAMPUS_NAME;
...
$this->phrasen['bewerbung/mailtextHtml']='Please display this message as HTML to see the complete link.';
$this->phrasen['bewerbung/mailtext']='Dear Mr/Mrs %1$s %2$s.<br><br>
        ...
        Best regards, <br>
        '.CAMPUS_NAME;
$this->phrasen['bewerbung/zugangsdatenFalsch']='The access code is not valid or you are not registered yet.';
...
$this->phrasen['bewerbung/sicherheitscodeFalsch']='The access code is not valid.';
$this->phrasen['bewerbung/geplanterStudienbeginn']='Planned Starting Date';
$this->phrasen['bewerbung/studienrichtung']='Desired Degree Program(s)';
$this->phrasen['bewerbung/bitteStudienrichtungWaehlen']='Please tick one degree program.';
...
$this->phrasen['bewerbung/captcha']='Please enter the text as seen in the picture (spam protection).';
