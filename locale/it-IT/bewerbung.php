<?php
$this->phrasen['bewerbung/ungueltigerZugriff']='accesso fallito';
$this->phrasen['bewerbung/welcome']='Benvenuto nella registrazione online';
$this->phrasen['bewerbung/registration']='Codice di accesso per la registrazione';
...
$this->phrasen['bewerbung/zugangscode']='Codice di accesso';
$this->phrasen['bewerbung/fallsVorhanden']='(se disponibile)';
...
$this->phrasen['bewerbung/mailtext']='Gentile %4$s %1$s %2$s,<br><br>
        ...
        Cordiali saluti, <br>
        '.CAMPUS_NAME;
$this->phrasen['bewerbung/zugangsdatenFalsch']='Il codice di accesso inserito è errato.';
$this->phrasen['bewerbung/fehlerBeimSenden']='Si è verificato un errore nell’invio della e-mail di conferma';
$this->phrasen['bewerbung/emailgesendetan']='L’e-mail con il suo codice di accesso è stata inviata con successo a %s.';
...
$this->phrasen['bewerbung/bitteGeschlechtWaehlen']='Per favore inserire il sesso.';
$this->phrasen['bewerbung/bitteEmailAngeben']='Per favore inserire un indirizzo e-mail valido.';
$this->phrasen['bewerbung/bitteStudienbeginnWaehlen']='Per favore selezionare l’inizio del periodo di studi.';
$this->phrasen['bewerbung/captcha']='Per favore riportare i caratteri dell’immagine (protezione antispam).';
$this->phrasen['bewerbung/andereGrafik']='Altra immagine';
$this->phrasen['bewerbung/datumFormat']='gg.mm.aaaa';
$this->phrasen['bewerbung/egal']='indifferente';
$this->phrasen['bewerbung/orgform']='Forma di organizzazione';
$this->phrasen['bewerbung/orgform/BB']='Di accompagnamento al lavoro';
$this->phrasen['bewerbung/orgform/VZ']='Tempo pieno';
$this->phrasen['bewerbung/orgform/teilzeit']='Tempo parziale';
$this->phrasen['bewerbung/orgform/DL']='A distanza (online)';
$this->phrasen['bewerbung/orgform/DDP']='Doppio titolo di studio';
...
$this->phrasen['bewerbung/berufstaetig']='occupato';
$this->phrasen['bewerbung/dienstgeber']='Datore di lavoro';
$this->phrasen['bewerbung/artDerTaetigkeit']='Attività lavorativa';
$this->phrasen['bewerbung/weiter']='Avanti';
$this->phrasen['bewerbung/eintragVom']='Inserimento del';
$this->phrasen['bewerbung/menuPersDaten']='Dati personali';
$this->phrasen['bewerbung/accountVorhanden']='Siccome è già in possesso di un account non è possibile modificare i dati. In caso di errori, la invitiamo di rivolgersi alla segreteria.<br><br>';
$this->phrasen['bewerbung/bitteAuswaehlen']='-- Selezionare per favore --';
$this->phrasen['bewerbung/menuKontaktinformationen']='Informazioni di contatto';
$this->phrasen['bewerbung/kontakt']='Contatto';
...
$this->phrasen['bewerbung/dokumentName']='Nome documento';
$this->phrasen['bewerbung/benoetigtFuer']='Necessario per';
$this->phrasen['bewerbung/dokumentErforderlich']='Documento obbligatorio';
$this->phrasen['bewerbung/dokumentOffen']='Carica documento';
$this->phrasen['bewerbung/dokumentNichtUeberprueft']='Documento inviato ma non ancora approvato';
$this->phrasen['bewerbung/dokumentWirdNachgereicht']='Documento verrà inviato prossimamente';
$this->phrasen['bewerbung/dokumentWurdeUeberprueft']='Documento approvato';
$this->phrasen['bewerbung/abgegeben']='inviato';
$this->phrasen['bewerbung/upload']='Carica';
$this->phrasen['bewerbung/menuZgv']='ZGV';
$this->phrasen['bewerbung/menuZugangsvoraussetzungen']='Requisiti di accesso';
$this->phrasen['bewerbung/fuer']='per';
$this->phrasen['bewerbung/artDerVoraussetzung']='Tipo di requisito';
$this->phrasen['bewerbung/menuZahlungen']='Pagamenti';
$this->phrasen['bewerbung/zahlungsinformation']='Informazioni di pagamento';
$this->phrasen['bewerbung/bezahlt']='saldato';
$this->phrasen['bewerbung/zahlungsdetails']='Dettagli pagamento';
$this->phrasen['bewerbung/menuReihungstest']='Test d’ingresso';
$this->phrasen['bewerbung/fuerReihungstestAnmelden']='Si può candidare per i seguenti test d’ingresso:';
$this->phrasen['bewerbung/fehler']='Si è verificato un errore';
$this->phrasen['bewerbung/angemeldetPlaetze']='candidati / posti';
$this->phrasen['bewerbung/uhrzeit']='Ora';
$this->phrasen['bewerbung/stornieren']='annullare';
$this->phrasen['bewerbung/menuBewerbungAbschicken']='Invia richiesta colloquio';
$this->phrasen['bewerbung/erklaerungBewerbungAbschicken']='Se ha completato l’inserimento dei dati, può inviare la propria richiesta colloquio.	La segreteria la contatterà nei prossimi giorni.';
$this->phrasen['bewerbung/erklaerungBewerbungAbschicken2']='Per favore verifichi i dati inseriti.<br>
		Per completare l’invio della richiesta colloquio selezionare l’apposito comando:';
$this->phrasen['bewerbung/bewerbungAbschickenFuer']='Inviare richiesta colloquio per';
$this->phrasen['bewerbung/buttonBewerbungAbschicken']='Invia richiesta colloquio';
$this->phrasen['bewerbung/logout']='Logout';
$this->phrasen['bewerbung/einzahlungFuer']='Pagamento per';
$this->phrasen['bewerbung/zahlungsinformationen']='Informazioni pagamento';
$this->phrasen['bewerbung/buchungstyp']='Tipo';
$this->phrasen['bewerbung/buchungstext']='Descrizione';
$this->phrasen['bewerbung/betrag']='Importo';
$this->phrasen['bewerbung/zahlungAn']='Pagamento a';
$this->phrasen['bewerbung/empfaenger']='Ricvente';
$this->phrasen['bewerbung/iban']='IBAN';
$this->phrasen['bewerbung/bic']='BIC';
$this->phrasen['bewerbung/zahlungsreferenz']='Riferimento di pagamento';
$this->phrasen['bewerbung/buchungsnummerNichtVorhanden']='Numero della voce %s non trovato';
$this->phrasen['bewerbung/teilweiseVollstaendig']='parzialmente completato';
$this->phrasen['bewerbung/vollstaendig']='completo';
$this->phrasen['bewerbung/unvollstaendig']='incompleto';
...
$this->phrasen['bewerbung/dokumentuploadZuBewerbung']='Upload documento %s per richiesta colloquio';
$this->phrasen['bewerbung/maennlich']='Maschio';
$this->phrasen['bewerbung/weiblich']='Femmina';
$this->phrasen['bewerbung/maturazeugnis']='Diploma di maturità';
$this->phrasen['bewerbung/details']='Dettagli';
$this->phrasen['bewerbung/codeZuschicken']='Invia codice di accesso';
$this->phrasen['bewerbung/codeZuschickenAnleitung']='Se ha già effettuato la registrazione ed ha perso il codice di accesso, può farsi inviare nuovamente il codice di accesso. Per favore inserisca il suo indirizzo e-mail e clicchi su "Invia codice di accesso"';
$this->phrasen['bewerbung/keinCodeVorhanden']='Per questa e-mail non è ancora stato assegnato un codice di accesso. Per favore <a href="'.$_SERVER['PHP_SELF'].'?method=registration">registrarsi</a>.';
$this->phrasen['bewerbung/zgvDatumNichtZukunft']='La data per il requisito di accesso non può essere impostata per il futuro. Se potrà soddisfare più tardi il requisito di accesso, proceda lasciando vuoto il campo per la data.';
$this->phrasen['bewerbung/ab']='da';
$this->phrasen['bewerbung/adresse']='Indirizzo (Residenza)';
$this->phrasen['bewerbung/notizVom']='Notifica del';
$this->phrasen['bewerbung/anmerkung']='Note';
$this->phrasen['bewerbung/anmerkungPlaceholder']='Qui è possibile inserire osservazioni particolari da comunicare alla segreteria';
...
$this->phrasen['bewerbung/zugangscodeVergessen']='Ha dimenticato il codice di accesso?';
